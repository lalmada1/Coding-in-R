...
There is a **LAB-05 RMD template** available for download. 


<a href='lab-05-template.rmd' target="_blank">
<button type="button" class="button"> TEMPLATE </button>
</a>
...
dat$age <- cut( dat$Age_Drv1, 
                breaks=c(16,18,25,35,45,55,65,75,100), 
                labels=age.labels )
