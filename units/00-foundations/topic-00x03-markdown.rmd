...
![](img/keep-calm-and-markdown.png)
...
3. Paste the iframe text into your markdown document. You can change or remove arguments like width, height, and player options.
4. Add the argument **data-external="1"**.   

```
<iframe width="560" height="315" 
        src="https://www.youtube.com/embed/VVRHTF5Ikro" 
