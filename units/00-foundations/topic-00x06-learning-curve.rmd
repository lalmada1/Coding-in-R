...
<center><h2><i> Nailed it, Pablo  </i></h2></center>
...
knitr::include_graphics("img/learning-curve-01.png")
```
...
```{r, echo=F, fig.align="center", out.width="90%"}
knitr::include_graphics("img/learning-curve-02.png")
```

<br>

```{r, echo=F, fig.align="center", out.width="90%"}
knitr::include_graphics("img/learning-curve-03.png")
```
